...
export default function AboutPage() {
  return (
    <Box>
      ...
      {/* Main Content */}
      <VStack spacing={8} align="stretch" maxWidth="800px" margin="auto" mt={8} px={4}>
        <Text fontSize="lg">
      ...
      <Box bg="blue.500" py={12} mt={12}>
        <Box maxWidth="800px" margin="auto" bg="white" borderRadius="md" p={6}>
      ...
      {/* Core Values */}
      <Box maxWidth="800px" margin="auto" mt={12} px={4}>
      ...
      {/* Navigation Arrows */}
      <HStack justify="space-between" maxWidth="800px" margin="auto" mt={8} mb={8}>
